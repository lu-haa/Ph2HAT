...
\begin{flushright}
	$\boxed{\textbf{Buch S. 267}}$
\end{flushright}


Wärmeaustausch zwischen verschiedenen Materialien $\Rightarrow$ \cbl{\hyperref[subsec:Dampf]{Beispiel Dampf}}

\smallskip

In einem abgeschlossenen System (nach aussen isoliert) muss gelten: \\
\colorbox{violet}{Zugeführte Wärme = Abgeführte Wärme}
