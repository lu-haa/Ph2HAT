...
\subsection{Adiabaten-Gleichung}
...
\begin{tabular}{c l c}
	$\kappa$ & Adiabatenkoeffizient & $[\kappa] = 1$
\end{tabular}
...
\begin{flushright}
	$\boxed{\textbf{Buch S. 256}}$
\end{flushright}


$$ \boxed{ p \cdot V = n \cdot R \cdot T = N \cdot k \cdot T }$$
$$\boxed{p \cdot V = \frac{2}{3} \cdot N \cdot \frac{m\cdot v^2}{2}}$$
...
\subsection[Arbeit von Gasen -isotherm]{Arbeit $\bm{\Delta W}$ von Gasen -isotherm}
\label{MechArbeit}

Folgende Formel ist für Flüssigkeiten \textbf{nicht} gültig, da diese inkompressibel sind ($\Delta V = 0$)

$$ \boxed{ \Delta W = F \cdot \Delta s = p \cdot A \cdot \Delta s = \colorbox{violet}{$p \cdot \Delta V$}} $$
...
\subsection{Osmotischer Druck (Zelldruck)}
